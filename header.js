   ...
   <div class="row mt-3">
     ...
     <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
       ...
       <div class="cell-sm-6 cell-lg-3 cell-xl-4"><a rel="noopener" href="/index.html"><img class="img-responsive"
         src="/assets/webp/dbit-logo-inverse.webp" alt="DBIT" width="250" height="80" /></a>
     <p class="offset-top-20 offset-md-top-35 inset-xl-right-30" style="color:white;padding: 1rem; text-align: left;"><b>Don Bosco Institute of Technology offers high-quality education to students in the field of engineering. With our help, you can master any sphere you prefer, from computer engineering to mechanical engineering.</b></p>
   </div>
     </div>
     ...
     ">
       <!-- Links -->
       <p  style=" text-align: left;"><b><h5 style=" text-align: left;" >Department of Basic Sciences & Humanities</h5></b><br>

         Ground Floor, A Wing <br>
         
         Don Bosco Institute Of Technology Premier Automobiles Road, Opp. Fiat Company, Kurla (W), Mumbai- 400 070 <br>
       
         <b>Contact :</b> 022-25042424 / 022-25040508 <br>
